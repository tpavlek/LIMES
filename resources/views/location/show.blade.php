...
@section('content')
    ...
    <div class="text-center">
        <a href="{{url()->current()."/new"}}" class="btn bg-green-dark hover:bg-green-darker text-white px-4 py-2 border-green-darkest text-xl leading-loose shadow rounded mb-4">
