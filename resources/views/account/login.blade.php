...
@section('content')
    <div class="p-4 mx-4 border-b border-l border-r shadow bg-white">
        ...
        <form action="{{ URL::route('login') }}" method="post">
            ...
            <input type="text" name="email" id="email" placeholder="email@address.com" class="my-2 bg-grey-light p-2 rounded w-full" />
    ...
    <div class="p-4 m-4 border-b border-l border-r shadow bg-white">
        ...
        <form action="{{ URL::route('register') }}" method="post">
            ...
            <label for="password_confirmed" class="tracking-wide font-bold text-sm text-grey-dark">CONFIRM</label>
            <input type="password" name="password_confirmed" id="password_confirmed" placeholder="Doubly secret, double the safety" class="my-2 bg-grey-light p-2 rounded w-full" />
        </form>
